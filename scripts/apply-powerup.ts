/**
 * Áp dụng migration power-up vào Supabase.
...
const sql = readFileSync(new URL("../supabase/powerup.sql", import.meta.url), "utf-8");
...
async function main() {
  ...
  try {
    ...
    console.log("✓ Power-up migration applied.");
  } catch (e: any) {
